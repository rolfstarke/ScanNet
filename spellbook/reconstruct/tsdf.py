"""Shared TSDF integration for the zed and open3d engines (track-then-reintegrate
architecture, same as ScanNet's BundleFusion poses -> VoxelHashing mesh).

Pose source: the caller's own poses (ZED tracking for the zed engine; Stage A poses for
the open3d engine). ScanNet parameters: voxel 2 cm (DEVIATION, see integrate_tsdf),
truncation 0.06 m, depth 0.1-6.0 m, depth_scale 1000, integration res 320x240.
"""
import os
...
def integrate_tsdf(work, keep, poses=None):
