...
## Long Term memory and documentation

- Review reports, the action plan, build errors, and context.
- Put only repository structure and project goals in spellbook/PROJECT_STATUS.md; never debugging or activity logs.
